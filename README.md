...
- `DAY_ID` is shuffled — no lags or ordering. Season *is* recoverable (solar kept its annual sinusoid;
  temperature was released as an anomaly) but carries no target signal.
